<?php
// Зміни були в ось таких рядках: 5,6,68,135
    ...
    if ($projectToEdit) {
        ...
        <center>
            <form method="POST">
                ...
                <label>
                    Кошторис
                    <input name="edit-estimate" type="number" id="edit-estimate"
                           value="<?= $projectToEdit['estimate']; ?>">
                </label><br>
                <label>
                    Перша оцінка
                    <input name="edit-score1" type="number" id="edit-score1"
                           value="<?= $projectToEdit['scores']['score1']; ?>">
                </label><br>
                <label>
                    Друга оцінка
                    <input name="edit-score2" type="number" id="edit-score2"
                           value="<?= $projectToEdit['scores']['score2']; ?>">
                </label><br>
                <label>
                    Третя оцінка
                    <input name="edit-score3" type="number" id="edit-score3"
                           value="<?= $projectToEdit['scores']['score3']; ?>">
                </label><br>
