...
function findProjectByCode($projects, $code){
    foreach($projects as $project){
        if(isset($project['code'])&&$project['code']===$code){
            return $project;
        }
    }
    return false;
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["edit-code"])) {
    ...
    $projectToEdit = findProjectByCode($projects,$editCode);
    ...
    if($projectToEdit){
        ...
        <form method="POST">
            ...
            <label>
                Перша оцінка
                <input name="edit-score1" type="number" id="edit-score1" value="<?= $projectToEdit['score']['score1'];?>">
            </label><br>
            <label>
                Друга оцінка
                <input name="edit-score2" type="number" id="edit-score2" value="<?= $projectToEdit['score']['score2'];?>">
            </label><br>
            <label>
                Третя оцінка
                <input name="edit-score3" type="number" id="edit-score3" value="<?= $projectToEdit['score']['score3'];?>">
            </label><br>
        </form>
        <?php
    }
...
//        ?>
<!--        <form method="post">-->
<!--            <input type="hidden" name="editCode" value="--><?php //= $editCode; ?><!--">-->
<!--            <label for="editFullName">Full name</label>-->
<!--            <input name="editFullName" type="text" id="editFullName" value="--><?php //= $employeeToEdit['fullName']; ?><!--">-->
<!--            <br>-->
<!--            <label for="editPosition">Position</label>-->
<!--            <input name="editPosition" type="text" id="editPosition" value="--><?php //= $employeeToEdit['position']; ?><!--">-->
<!--            <br>-->
<!--            <label for="editSalary">Salary</label>-->
<!--            <input name="editSalary" type="text" id="editSalary" value="--><?php //= $employeeToEdit['salary']; ?><!--">-->
<!--            <br>-->
<!--            <label for="editChildrenAmount">Amount of children</label>-->
<!--            <input name="editChildrenAmount" type="text" id="editChildrenAmount" value="--><?php //= $employeeToEdit['childrenAmount']; ?><!--">-->
<!--            <br>-->
<!--            <label for="editWorkExperience">Work experience</label>-->
<!--            <input name="editWorkExperience" type="text" id="editWorkExperience" value="--><?php //= $employeeToEdit['workExperience']; ?><!--">-->
<!--            <br />-->
<!--            <br />-->
